...
public:
     ...
     */
    ParseResult parse_http_request_enhanced(const httplib::Request& req,
                                            const std::string& session_id = "");
     ...
     */
    std::unique_ptr<UnifiedMessage> parse_websocket_message(const std::string& raw_message,
                                                            const std::string& session_id = "");
     ...
     */
    ParseResult parse_websocket_message_enhanced(const std::string& raw_message,
                                                 const std::string& session_id = "");
