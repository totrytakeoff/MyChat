-- MyChat core schema baseline.
--
-- This migration is intentionally non-destructive. It mirrors the current ODB
-- generated table shapes but replaces DROP/CREATE with idempotent CREATE IF
-- NOT EXISTS statements so it can be run against an existing development
-- database without deleting user data.
